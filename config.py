...
# NAMA OWNER
OWNER = os.environ.get("OWNER", "itsiannnn")
...
# Database
DB_URI = os.environ.get("DATABASE_URL", "postgresql://postgres:YmfsZNRqQybathM1@fallaciously-surpassing-dog.data-1.use1.tembo.io:5432/postgres")
...
try:
    ADMINS = [int(x) for x in (os.environ.get("ADMINS", "1494610306 1846991467 5015444972 6108349281 6440848191 7092423624").split())]
except ValueError:
